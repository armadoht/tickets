		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="hero">
					...
					<a class="btn btn-danger" href="index.php?controller=ticket&action=read_ticket&valor=">Ver mas...</a>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		$(document).ready( function () {
			$('.show-ticket').click(function (){
				let direccion_ip = $(this).val();
				location.href = "index.php?controller=ticket&action=read_ticket";
			})
        } );
